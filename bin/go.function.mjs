...
import { getInteractiveArgs } from "./command.utils.mjs";
import { commands } from "./commands.mjs";
export async function go() {
    // default set the "label" property of interactive options
    Object.values(commands).forEach((config) => Object.entries(config.vars || {}).forEach(([key, option]) => (option.name = option.name || key)));
...
//# sourceMappingURL=go.function.mjs.map